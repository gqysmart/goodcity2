...
@Component({
  selector: 'gc-imodel-table',
  styleUrls: ['./gcSmartTable.component.scss'],
  templateUrl: './gcSmartTable.component.html',
})
export class GcSmartTableComponent implements OnChanges {
